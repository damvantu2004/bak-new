        ...
        <div class="main-form-content">
            ...
            <div class="row mb-3">
                ...
                <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                    <label for="fname">Tên riêng</label>
                    <input type="text" placeholder="Nhập vào tên riêng *" name="fname" id="su-fname" onkeyup="validateName(this, 'First name')">
                    <small id="su-fname-err"></small>
                </div>

                <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                    <label for="lname">Họ đệm</label>
                    <input type="text" placeholder="Nhập vào họ đệm *" name="lname" id="su-lname" onkeyup="validateName(this, 'Last name')">
            ...
            <div class="row mb-3">
                <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                    ...
                    <input type="text" placeholder="Nhập vào địa chỉ email *" name="email" id="su-email" onkeyup="validateEmail(this)">
                    <small id="su-email-err"></small>
                </div>

                <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                    <label for="phone">Số điện thoại</label>
                    <input type="text" placeholder="Nhập vào số điện thoại *" name="phone" id="su-phone" onkeyup="validatePhone(this)">
            ...
            <input type="text" class="mb-3" placeholder="Nhập vào địa chỉ *" name="address" id="su-address" onkeyup="validateNotEmpty(this, 'Address')">
            ...
            <div class="row mb-3">
                <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                    ...
                    <input type="password" placeholder="Nhập vào mật khẩu *" name="password" id="su-psw" onkeyup="validatePassword(this)">
            ...
            <p class="text-center" style="margin-bottom: 0; margin-top: 16px">Bằng cách tạo tài khoản, bạn đồng ý với
                <a href="#" style="color:var(--primary-color)">Điều khoản & Chính sách bảo mật</a> của chúng tôi.
            </p>
